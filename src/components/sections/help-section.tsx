   ...
   return (
      ...
      >
         ...
         <div className="max-w-6xl mx-auto relative">
            {/* FAQ — thin label, accordion opens directly */}
            ...
            {/* Location — map opens, heading secondary */}
            <div>
                  ...
                  {contactInfo.map((info, index) => (
                     ...
                     >
                        ...
                        <a
                           ...
                           className="mt-4 inline-block text-champagne text-sm tracking-wider uppercase hover:text-champagne/80 transition-colors animated-underline"
                        >
                           {info.action}
                        </a>
                     </div>
