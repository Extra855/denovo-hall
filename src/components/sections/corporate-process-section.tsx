...
export function CorporateProcessSection() {
   ...
   const steps = [
      { number: "01", title: t("process.items.0.title"), description: t("process.items.0.description"), duration: t("process.items.0.duration") },
      { number: "02", title: t("process.items.1.title"), description: t("process.items.1.description"), duration: t("process.items.1.duration") },
      { number: "03", title: t("process.items.2.title"), description: t("process.items.2.description"), duration: t("process.items.2.duration") },
      { number: "04", title: t("process.items.3.title"), description: t("process.items.3.description"), duration: t("process.items.3.duration") },
   ];

   const tips = [
      { number: "01", title: t("process.tips.0.title"), description: t("process.tips.0.description") },
      { number: "02", title: t("process.tips.1.title"), description: t("process.tips.1.description") },
      { number: "03", title: t("process.tips.2.title"), description: t("process.tips.2.description") },
      { number: "04", title: t("process.tips.3.title"), description: t("process.tips.3.description") },
   ];
   ...
   return (
      <section id="corporate-process" className="py-24 md:py-32 lg:py-40 px-6 bg-charcoal relative overflow-hidden">
         <div
         ...
         <div className="max-w-6xl mx-auto relative">
            ...
            {/* Timeline steps — horizontal snap carousel on mobile */}
                  ...
                  return (
                     ...
                     >
                        ...
                        <div className="pt-1">
                           ...
                           >
                              {isExpanded ? t("process.readLess") : t("process.readMore")}
                           </button>
                        </div>
                     </div>
                  );
